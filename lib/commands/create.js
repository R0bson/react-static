          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                console.log(_chalk2.default.green('Downloading template: ' + template));
                _context2.next = 6;
              ...
              case 8:
                ...
                console.log(_chalk2.default.red('Download of ' + template + ' failed'));
                throw _context2.t0;
              ...
              case 28:
                ...
                console.log(_chalk2.default.green('Using template: ' + template));
              ...
              case 34:
                ...
                console.log(_chalk2.default.red('Copying the template: ' + template + ' failed'));
                throw _context2.t2;

              case 38:
                _context2.prev = 38;

                console.log(_chalk2.default.green('Using template from directory: ' + template));
                _context2.next = 42;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 25:
            ...
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] Project "' + name + '" created'));
          ...
          case 39:
            ...
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] Project "' + name + '" created'));
