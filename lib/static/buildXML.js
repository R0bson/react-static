...
exports.default = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref6) {
    ...
    var routes, _config$paths, paths, disableRoutePrefixing, DIST, siteRoot, prefixPath, xml;

    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            routes = config.routes, _config$paths = config.paths, paths = _config$paths === undefined ? {} : _config$paths, disableRoutePrefixing = config.disableRoutePrefixing;
            DIST = paths.DIST;
            siteRoot = getSiteRoot(config);
            prefixPath = disableRoutePrefixing ? siteRoot : process.env.REACT_STATIC_PUBLICPATH;
