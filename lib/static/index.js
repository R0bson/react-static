...
exports.exportRoutes = exports.fetchRoutes = exports.exportSharedRouteData = exports.fetchSiteData = exports.prepareRoutes = exports.extractTemplates = exports.buildXMLandRSS = undefined;
...
var extractTemplates = exports.extractTemplates = function extractTemplates(config) {
...
var prepareRoutes = exports.prepareRoutes = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt('return', (0, _getRoutes2.default)({
              config: config,
              opts: opts
            }, function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(routes) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 4;
                        return (0, _generateRoutes2.default)({
                          config: config
                        });
  ...
  return function prepareRoutes(_x) {
    return _ref.apply(this, arguments);
  };
}();

var fetchSiteData = exports.fetchSiteData = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(config) {
    var siteData;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] Site Data Downloaded'));
            // Get the site data
            _context3.next = 4;
          ...
          case 4:
            ...
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] Site Data Downloaded'));
            return _context3.abrupt('return', siteData);
...
var exportSharedRouteData = exports.exportSharedRouteData = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(config, sharedProps) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] Shared Route Data Exported'));
          ...
          case 7:
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] Shared Route Data Exported'));
...
var fetchRoutes = exports.fetchRoutes = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee8(config) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] Route Data Downloaded'));
            _context8.next = 7;
          ...
          case 7:
            ...
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] Route Data Downloaded'));

            console.log('=> Exporting Route Data...');
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] Route Data Exported'));
            _context8.next = 12;
            return (0, _shared.poolAll)(config.routes.map(function (route) {
          ...
          case 12:
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] Route Data Exported'));
...
var buildHTML = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee10(_ref11) {
    var config = _ref11.config,
        siteData = _ref11.siteData,
        clientStats = _ref11.clientStats;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            (0, _utils.time)(_chalk2.default.green('=> [\u2713] HTML Exported'));
            ...
            return (0, _shared.poolAll)(config.routes.map(function (route) {
              return _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee9() {
                var sharedPropsHashes, templateID, localProps, allProps, routePath, routeInfo, embeddedRouteInfo, InitialPropsContext, renderMeta, chunkNames, head, clientScripts, clientStyleSheets, clientCss, FinalComp, renderToStringAndExtract, appHtml, DocumentHtml, html, htmlFilename, routeInfoFilename, res;
                  ...
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      ...
                      case 21:
                        ...
                        _context9.t0.message = 'Failed exporting HTML for URL ' + route.path + ' (' + route.component + '): ' + _context9.t0.message;
                        throw _context9.t0;
                      ...
                      case 25:
                        ...
                        // inside a directory.
                        htmlFilename = route.path === '404' ? _path2.default.join(config.paths.DIST, '404.html') : _path2.default.join(config.paths.DIST, route.path, 'index.html');
                ...
                }, _callee9, undefined, [[15, 21]]);
              }));
            }), Number(config.outputFileRate) || defaultOutputFileRate);

          case 10:
            (0, _utils.timeEnd)(_chalk2.default.green('=> [\u2713] HTML Exported'));
...
var exportRoutes = exports.exportRoutes = function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee11(_ref14) {
    var config = _ref14.config,
        clientStats = _ref14.clientStats;
    var siteData;
